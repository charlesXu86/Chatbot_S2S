...
# nezha配置
config_path = basedir + '/model/saved_models/bert_config.json'
checkpoint_path = basedir + '/model/saved_models/model.ckpt-900000'
dict_path = basedir + 'model/saved_models/vocab.txt'
